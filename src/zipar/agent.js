...
function loadAllFiles(appPath, moduleMap) {
  ...
  while (true) {
    ...
    if (fullPath.hasSuffix_(".dylib")) {
      ...
      _parseAndSendModule(mod2, file.toString());
      continue;
    }
