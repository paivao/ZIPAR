...
function sendPatch(name, memory, length, start, cryptIdPos) {
  let offset = 0;
  send({ beginPatch: name, patchSize: length, cryptIdPos });
  while (offset < length) {
